 ...
 * @endcode
 */
$settings['hash_salt'] = 'GS7GXeWwN8osFm2NXXeN_hdf22ebwSa0_noYru3_V1YX_tEkt5qNJrtY7vE9EiVWg7wpkZUKIg';
...
$settings['trusted_host_patterns'] = [
  '^localhost$',
  '^127.0.0.1$',
  '^software-inventory\.sciencehistory\.org$',
  'example\.local$',
  'staging\.example\.com$',
  'example\.com$',
];
...
# Moved the database configuration to sites/default/settings/settings.local.php

$settings['config_sync_directory'] = 'sites/default/files/config_v8GLWeGnKeyj1HqKGJ_IBzYfV1Ts5HY71haopgyQ3d0M9c_inNAYXKwzx2m0lkUdIAh0e8sO6g/sync';
